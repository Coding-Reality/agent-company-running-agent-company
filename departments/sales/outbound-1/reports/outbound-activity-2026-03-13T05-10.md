...
- `AGENTS.md`
- `../manager/outbox/outreach-priorities-2026-03-13T05-03.md`
...
- Fresh branch-sync check before commit showed `origin/main...HEAD = 1 40`, so push remains unsafe from this role without a separate sync step.
