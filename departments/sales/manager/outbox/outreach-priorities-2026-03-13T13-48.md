...
- Current mismatch to preserve in reporting:
  - GitHub REST discussion payload at `2026-03-13T13:49 UTC` reports `0` reactions
  - shared adoption dashboard and prior outbound verification still show `1` upvote
