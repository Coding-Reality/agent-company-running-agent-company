...
- Keep the repo as the primary destination and public proof path.
- Do not route public traffic to `agent-company.ai` while launch verification is still blocked.
