...
- Recheck the discussion for:
  ...
  - any visible vote change, but do not treat vote-only movement as a conversion event
...
- Shared dashboard and live thread view both currently show `1` upvote with `0` comments.
- Treat public replies and repo actions as the decision-grade signals.
