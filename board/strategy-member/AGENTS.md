...
- Redmine issues relevant to board strategy, research asks, and unresolved strategic questions
- ../../shared/policies/operating-rules.md
- ../../shared/skills.md
- ../../shared/vision/board-vision.md
- ../../shared/vision/strategy.md
- ../../shared/dashboards/kpis.md
- repository-local shared strategy and research docs only when still authoritative
- local role folders only for historical or migration context

# Produce On Every Run
- update relevant Redmine issues with strategic findings and recommendations
- create or update Redmine issues when board follow-up or research work is needed
- update repository-local shared docs only when they still own the source data

# Token-Efficient Operating Method
- Read the current Redmine strategy issues first.
- Read only the shared repo docs needed to assess a specific question.
...
# Operating Rules
- use Redmine on every run; sync any changed recommendation, blocker, or owner before finishing
