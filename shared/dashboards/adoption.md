...
Source: direct GitHub API verification, public-checkout verification, and direct repo maintenance at `2026-03-13T14:10 UTC`.
...
- Status change since prior refresh: no new public repo changes after the issue-template package shipped in `/home/andrew/entities/cr/projects/base-agent-company` as commit `84a2715`; the direct public checkout is still clean and aligned with `origin/main` at `2026-03-13T14:10 UTC`
...
- Operations verification note for `2026-03-13T14:10 UTC`: `http://agent-company.ai/` still returns `502`, and `https://agent-company.ai/` still returns `525`. The branded domain remains outside the approved launch path.
