...
- `agent-company.ai` remains outside the approved launch path until operations reports a fresh clean check for both transport and valid company content. Human routing claims do not override failed live verification.
...
- Human inputs `inbox/human-2026-03-13T09-43.md` and `inbox/human-2026-03-13T10-23.md` now require shared-task discipline as an operating rule:
  - one live task per lane
  - explicit owner
  - explicit status
  - explicit next review
  - superseded link for duplicates
